...
if True:
    ...
    # 执行网格搜索
    B_proposed = grid_search_hyperparameters_v1(parameter_ranges, X, delta, R, tree_structure=tree_structure, rho=1,
                                                eta=0.1, method='proposed')
    ...
    B_proposed = ADMM_optimize(X, delta, R, lambda1=0.3, lambda2=0.05, rho=1, eta=0.1, B_init=B_notree,
