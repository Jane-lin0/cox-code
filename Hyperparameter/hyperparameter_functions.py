...
def evaluate_hyperparameters(params, X, delta, R, rho, eta):
    ...
    print(f"lambda1={lambda1}, lambda2={lambda2}, mBIC={mbic:.1f}")
...
def hyperparameter_figure(parameter_ranges, mbic_records, best_params):
    ...
    if False:
        ...
        sns.heatmap(mbic_matrix, xticklabels=lambda2_values_formatted, yticklabels=lambda1_values_formatted,
                    annot=True, fmt=".0f", annot_kws={"size": 8}, cmap="YlGnBu", cbar_kws={"label": "mBIC"})
